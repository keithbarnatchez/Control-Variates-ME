...
etas <- c(0.1,-0.2,0.6,0.25,0.25) # selection prob coefficients (can be turned off)
...
n_grid <-  5000 # c(1000,2500,5000,10000)  # sample size of main data
...
eta_grid <- c(TRUE) # when true, selection into val. data depends on X
